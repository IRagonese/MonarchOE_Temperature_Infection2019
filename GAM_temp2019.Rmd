...
mtemp.comp<-read.csv("mtemp_comp_Nov1_2021.csv") #master data
...
merozoite_df<-read.csv("Merozoites_7_21.csv")
...
plot.new()
plot_smooth(m1_mixed, view = "Temp", rm.ranef = FALSE, col="darkgoldenrod3", lwd=2, rug = TRUE, ylab=("Development time (log10(days))"), xlab=("Temperature (°C)"), hide.label = TRUE)
plot_data(m1_mixed, view = "Temp", input="data", rm.ranef = FALSE, add = TRUE, alpha=0.7, col="darkgray", hide.label = TRUE)
...
plot_data(m1_mixed, view = "Temp", input="data", rm.ranef = FALSE, add = TRUE, alpha=0.7, col="black", hide.label = TRUE)
...
#add itsadug points- need to put all lines into the console
plot.new()
plot_data(m1_mixed, view = "Temp", input="data", rm.ranef = FALSE, alpha=0.7, col="darkgray", ylab=("Larval hemocycte conc.(log10(cells/ul))"), xlab=("Temperature (°C)"), hide.label = TRUE)
plot_smooth(m1_mixed, view = "Temp", add = TRUE, rm.ranef = FALSE, col="#009E73", lwd=2, rug = TRUE, hide.label = TRUE)
axis(1, at=c(15,35), labels=c("",""), lwd.ticks=0)

#Mass
plot.new()
plot_data(m1_mixed, view = "Mass", input="data", rm.ranef = FALSE, alpha=0.7, col="darkgray", ylab=("Larval hemocycte conc.(log10(cells/ul))"), xlab=("Mass (g)"), hide.label = TRUE)
...
#add itsadug points- need to put all lines into the console
plot.new()
plot_data(m2_mixed, view = "Temp", input="data", rm.ranef = FALSE, alpha=0.7, col="darkgray", ylab=("Pupal hemocycte conc.(log10(cells/ul))"), xlab=("Temperature (°C)"), hide.label = TRUE)
plot_smooth(m2_mixed, view = "Temp", add = TRUE, rm.ranef = FALSE, col="#009E73", lwd=2, rug = TRUE, hide.label = TRUE)
axis(1, at=c(15,35), labels=c("",""), lwd.ticks=0)
```
...
#add itsadug points- need to put all lines into the console
plot.new()
plot_data(m2_mixed, view = "Temp", input="data", rm.ranef = FALSE, alpha=0.7, col="darkgray", ylab=("Larval PO activity (absorbance)"), xlab=("Temperature (°C)"), hide.label = TRUE)
plot_smooth(m2_mixed, view = "Temp", add = TRUE, rm.ranef = FALSE, col="#009E73", lwd=2, rug = TRUE, hide.label = TRUE)
axis(1, at=c(15,35), labels=c("",""), lwd.ticks=0)

#mass
plot.new()
plot_data(m2_mixed, view = "Mass", input="data", rm.ranef = FALSE, alpha=0.7, col="darkgray", ylab=("Larval PO activity (absorbance)"), xlab=("Mass (g)"), hide.label = TRUE)
plot_smooth(m2_mixed, view = "Mass", add = TRUE, rm.ranef = FALSE, col="#009E73", lwd=2, rug = TRUE, hide.label = TRUE)
axis(1, at=c(0,2.0), labels=c("",""), lwd.ticks=0)
...
plot_data(m1_mixed, view = "Temp", input="data", alpha=0.7, col="black", main="", ylim=c(0.5,3.0), ylab=("Pupal PO activity (absorbance)"), xlab=("Temperature (°C)"), hide.label = TRUE)
plot_smooth(m1_mixed, view = "Temp", add = TRUE, rm.ranef = FALSE, col="#009E73", lwd=2, rug = TRUE, hide.label = TRUE)
axis(1, at=c(15,35), labels=c("",""), lwd.ticks=0)
...
plot_smooth(m3_mixed, view = "Temp", add= TRUE, rm.ranef = FALSE, col="#009E73", lwd=2, rug = TRUE, hide.label = TRUE)
axis(1, at=c(15,35), labels=c("",""), lwd.ticks=0)
...
#add itsadug - need to put all lines into the console
plot.new()
plot_smooth(m2_mixed, view = "logSpore_load", rm.ranef = FALSE, transform = plogis, col="skyblue2", lwd=2, rug = TRUE, ylab=("Probability of Wing Deformity"), xlab=("log10 Spore load of infected monarchs"), hide.label = TRUE)
axis(1, at=c(15,35), labels=FALSE, lwd.ticks=0)
...
#add itsadug points- need to put all lines into the console
plot.new()
plot_smooth(m1_mixed, view = "Temp", plot_all = "inoc_status", rm.ranef = FALSE, col=c("purple", "black"), lwd=2, rug = TRUE, ylab=("Development time (log10(days))"), xlab=("Temperature (°C)"), hide.label = TRUE)
axis(1, at=c(15,35), labels=FALSE, lwd.ticks=0)
#axis(1, at=seq(18 , 34, by=4), lwd=0, lwd.ticks=1)

plot.new()
plot_smooth(m2_mixed, view = "intensity4",  rm.ranef = FALSE, lwd=2, rug = TRUE, ylab=("Development time (log10(days))"), xlab=("log spore load"), hide.label = TRUE)
axis(1, at=c(15,35), labels=FALSE, lwd.ticks=0)
#axis(1, at=seq(18 , 34, by=4), lwd=0, lwd.ticks=1)
...
plot.new()
plot_smooth(m2_mixed, view = "intensity4",  rm.ranef = FALSE, lwd=2, rug = TRUE, ylab=("Development to pupa"), xlab=("log spore load"), hide.label = TRUE)
axis(1, at=c(15,35), labels=FALSE, lwd.ticks=0)
#axis(1, at=seq(18 , 34, by=4), lwd=0, lwd.ticks=1)
...
m0<-glm(response ~ 1, data = mtemp.inf1, family = negative.binomial(1))
m1<-glm(response ~ Temp + logSpore_load + Lineage, data = mtemp.inf1, family = negative.binomial(1))
m2<-glm(response ~ Temp*logSpore_load + Lineage + Sex + OE_strain, data = mtemp.inf1, family = negative.binomial(1))
m3<-glm(response ~ Temp*logSpore_load, data = mtemp.inf1, family = negative.binomial(1))
m4<-glm(response ~ logSpore_load, data = mtemp.inf1, family = negative.binomial(1))

AIC(m0,m1,m2,m3,m4)#best model is the one with just spore load explaining adult longevity (m4), used full model (m2 used in paper)
...
p1<-ggplot(mtemp.inf1, aes(x = logSpore_load, y = response, group = Temp_f, color = Temp_f, fill=Temp_f)) +
  labs(x = "Spore load (log10(spores/monarch))", y = "Adult longevity (days)") +
