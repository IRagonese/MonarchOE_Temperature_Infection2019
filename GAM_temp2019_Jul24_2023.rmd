...
m4_mixed<-gam(response ~ s(Temp, k=5) + s(Temp, k=5, by=OE_f) + OE_f + Sex_f + s(Lin_f, Temp, bs="re"), data=mtemp.adult, method = "REML", family = 'nb', link='log')
...
AIC(m0,m1,m2,m3,m4,m5)#best model 
